<template>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <!-- Card de busca -->
                <card-component title="Busca de clientes">
                        ...
                        <div class="row">
                            <div class="mb-3 col-6">
                                <input-container-component
                                    ...
                                    label="ID"
                                    help="idHelp"
                                    help-text="Opcional. Informe o id do cliente."
                                >
                                    <template v-slot:content>
                                        <input
                                            type="number"
                            ...
                            <div class="mb-3 col-6">
                                <input-container-component
                                    ...
                                    label="Nome"
                                    help="nomeHelp"
                                    help-text="Opcional. Informe o nome do cliente."
                                >
                                    <template v-slot:content>
                                        <input
                                            type="text"
                    ...
                    <template v-slot:content>
                        <table-component
                            ...
                            :see="{
                                visivel: true,
                                dataToggle: 'modal',
                                dataTarget: '#modalSeeCliente',
                            }"
                            :edit="{
                                visivel: true,
                                dataToggle: 'modal',
                                dataTarget: '#modalEditCliente',
                            }"
                            :remove="{
                                visivel: true,
                                dataToggle: 'modal',
                                dataTarget: '#modalRemoveCliente',
                            }"
                        ></table-component>
                    </template>
                    <template v-slot:footer>
        ...
        <!-- Modal de adição-->
        <modal-component id="modalAddCliente" title="Adicionar cliente">
        ...
        <modal-component id="modalSeeCliente" title="Visulizar cliente">
            <template v-slot:content>
        ...
        <!-- Modal de visualização-->
        <!-- Modal de edição-->
        <modal-component id="modalEditCliente" title="Editar cliente">
        ...
        <!-- Modal de edição-->
        <!-- Modal de remoção-->
        <modal-component id="modalRemoveCliente" title="Remover cliente">
            <template v-slot:alert v-if="$store.state.transation.status">
                <alert-component
                    :details="$store.state.transation"
                ></alert-component>
...
export default {
    ...
    data() {
        return {
            urlBase: "http://localhost:8000/api/cliente",
            transationDetails: {
                status: "",
                type: "",
                message: "",
